using Lists_n_Heaps.StateCommands.Commands;
using System;
...
namespace Lists_n_Heaps.StateCommands
{
    ...
    public class ImportCSVCommandFactory : AbstaractWordCommandFactory
    {
        public ImportCSVCommandFactory(DictionaryManager _dictionaryManager) : base(_dictionaryManager)
        {
            state = States.import;
        }
        ...
        public override IStateCommand GetCommand(States _state)
        {
            return new ImportCSVCommand(_state, this.dictionaryManager);
        }
    }
    public class MakeDictionaryBSTCommandFactory : AbstaractWordCommandFactory
    {
        public MakeDictionaryBSTCommandFactory(DictionaryManager _dictionaryManager) : base(_dictionaryManager)
        {
            state = States.BST;
        }
        ...
        public override IStateCommand GetCommand(States _state)
        {
            return new MakeDictionaryBSTCommand(_state, this.dictionaryManager);
        }
    }
}
